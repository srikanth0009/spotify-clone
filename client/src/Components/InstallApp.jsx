...
const InstallApp = () => {
  return (
   <div className="bg-black min-h-full">
                ...
                <div className="relative bg-gradient-to-br from-teal-200 via-purple-00 to-pink-600 px-6 pt-12 pb-0 overflow-hidden">
                  <div className="max-w-6xl mx-auto">
                    ...
                    <div className="max-w-xl">
                      <h1 className="text-5xl font-black text-black mb-6 text-balance">Download Spotify for Linux</h1>
                      <p className="text-lg text-black/80 mb-8 leading-relaxed">
                        Enjoy high-quality audio, offline playback, and a friend activity feed that lets you see what
                        your friends are listening to in real time.
                      </p>
                      <Button className="rounded-full bg-white text-black hover:bg-white/90 h-12 px-8 font-semibold text-base shadow-lg mb-12">
                    ...
                    <div className="flex justify-center">
                      <img
                        src="/InstallAppImage.png"
                        alt="Spotify Desktop App"
                        className="w-full max-w-4xl rounded-t-lg shadow-2xl"
                      />
                    </div>
                  </div>
                </div>

                {/* Footer - Reuse the SpotifyFooter structure */}
